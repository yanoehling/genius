...
pygame.mixer.init()
som_play = pygame.mixer.Sound('Sounds\Play.mp3')
som_fim = pygame.mixer.Sound('Sounds\Fim.mp3')
som_verde = pygame.mixer.Sound('Sounds\C.mp3')
som_vermelho = pygame.mixer.Sound('Sounds\D.mp3')
som_amarelo = pygame.mixer.Sound('Sounds\E.mp3')
som_azul = pygame.mixer.Sound('Sounds\F.mp3')
